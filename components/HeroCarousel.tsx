...
export default function HeroCarousel() {
  ...
  // Advances on its own and never stops — there are no arrows to drive it.
  useEffect(() => {
    const t = setInterval(
  ...
  return (
    <section className="w-full bg-white">
      {/* Edge to edge up to 1920px, then centred with even gutters — the same
          rule the category banners follow. */}
      <div className="relative mx-auto max-w-[1920px] h-[58vh] min-h-[400px] max-h-[540px] overflow-hidden">
        {heroSlides.map((s, i) => {
